...
export const startCommand = async (ctx) => {
    ...
    if (user?.role === "USER") {
        ...
        if (param) {
            ...
            ctx.reply(
                '*Привет 🙋‍♂️*\nЭто пилотный проект проведения мероприятий, будете нашими подопытными 🤝\nДизайн простой, немного с юмором, попробуйте зарегистрироваться 😁\n\n_Из\\-за того, что мы решили никаким образом не сжимать файлы, то они могут подгружаться немного дольше обычного_',
                {
